...
\end{minipage}
\begin{minipage}{13cm}
Eine Navigation zum Einsatzort soll mit Hilfe einer anderen App m\"oglich sein und zwar genau dann wenn die ankommende SMS dessen Koordinaten beinhaltet.\\
\end{minipage}
\begin{minipage}{3cm}
/LF60/
\end{minipage}
...
\end{minipage}
\begin{minipage}{13cm}
Erstellte Regeln m\"ussen gespeichert werden k\"onnen, so das der Nutzer einmal erstellte Regeln wieder aktivieren kann und diese beim schlie\ss{}en der Applikation nicht verloren gehen.\\
\end{minipage}
\begin{minipage}{3cm}
/LD20/
\end{minipage}
...
\end{minipage}
\begin{minipage}{13cm}
Ein Regelaustausch mit anderen Nutzern soll grunds\"atzlich m\"oglich sein. Die Daten sollen in einem hief\"ur erstellten Format \"ubertragen werden.\\
\end{minipage}
\begin{minipage}{3cm}
/LD40/
\end{minipage}
\begin{minipage}{13cm}
Um den heute immer wichtiger werdenen Datenschutz gerecht zu werden, sollen keine nicht ben\"otigten Daten vom Telefon abgefragt, verarbeitet oder gesendet werden.\\
\end{minipage}
