...
Bei der LogCat handelt es sich um ein Logging-Tool welches jederzeit in Android aktiv ist und Log-Ausgaben von allen App's und dem Betriebssystem sammelt. Jede Applikation kann Informationen in das Log schreiben, wobei die Menge der Log-Zeilen vom Programmierer abh\"angig ist, da er selbst bestimmt, welche Informationen er in das Log schreibt.
...
Da es sich bei der LogCat um einen Ringpufferspeicher handelt, werden die \"alltesten Daten automatisch \"uberschrieben. Somit ist die Speicherdauer davon abh\"angig, wie viele Log-Eintr\"age in einer bestimmten Zeit gemacht werden. \cite{LogCat}
...
Google schl\"agt in seinen APIs die eben beschriebene Konstante wie folgt vor zu Implementieren.
